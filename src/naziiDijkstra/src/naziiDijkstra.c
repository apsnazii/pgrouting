...
#include "drivers/naziiDijkstra/naziiDijkstra_driver.h"  // the link to the C++ code of the function

PGDLLEXPORT Datum naziiDijkstra(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(naziiDijkstra);
...
process(
    ...
    time_msg(" processing pgr_naziiDijkstra", start_t, clock());
